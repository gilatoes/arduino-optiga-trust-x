...
## Boot Camp Hardware
For this part of training, XMC2Go (Infineon Technologies, XMC1100, Cortex M0), unless otherwise stated, will be used as the MCU for the security controller. This MCU needs to be connected to a Windows based PC for flashing the firmware.
...
For the ease of use, you will be issued with a XMC2Go with Sheidl2Go board. All the exercises should be accomplished using this mission board.

For manual wire jumping of XMC2Go board with a Trust X Shield2Go, please refer to schematic and PCB information [Mission Arduino - XMC2Go with Shield2Go]
